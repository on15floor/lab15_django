...
class Binance:
    ...
    def get_wallet(self):
        ...
        for coin in coins['balances']:
            ...
            balance = round(amount * price_in_usd, 2)
    ...
    def get_deposits(self):
        ...
        for coin in coins:
            ...
            price_in_usd = float(get_pair_price(ticker))
            balance = round(amount_total * price_in_usd, 2)
            profit = round(earn * price_in_usd, 2)
...
def build_collection_crypto():
    ...
    bn = Binance(settings.BINANCE_API_KEY, settings.BINANCE_API_SECRET)
