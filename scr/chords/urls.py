...
from .views import ChordsView, ChordsInstrumentView, SongView, SongDelete, SongDetailsView

urlpatterns = [
    # Блог
    path('chords', ChordsView.as_view(), name='chords'),
    path('chords/<instrument>', ChordsInstrumentView.as_view(), name='chords_instrument'),
