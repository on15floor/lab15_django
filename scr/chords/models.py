...
ukulele_chords = {'A', 'A7', 'Am', 'Am7', 'Adim', 'Aaug', 'A6', 'Amaj7', 'A9',
...
guitar_chords = {'A', 'Am', 'A7', 'B', 'Bm', 'B7', 'C', 'Cm', 'C7', 'D', 'Dm', 'D7',
                 'E', 'Em', 'E7', 'F', 'Fm', 'F7', 'G', 'Gm', 'G7'}
...
class Song(models.Model):
    ...
    def get_ukulele_chords(self):
        return set(self.song_text.split()) & ukulele_chords

    @property
    def get_guitar_chords(self):
        return set(self.song_text.split()) & guitar_chords
